...
if (message.content.startsWith(prefix + 'help')) {
	...
	`=-=-=-=-=-= 🌍 Public Commands - اوامر عامة 🌍 =-=-=-=-=-=
     :beginner: -sug =====> To Suggest | لعمل اقتراح
    :beginner: -id ======> To Show Your ID | ايدي حسابك
    :beginner: -ping ====> Ping Of Bot | بنج حك البوت
    :beginner: -allbots => Show All Bots In The Server | لاضهار جميع البوتات
    :beginner: -bot =====> Information Of The Bot | معلومات البوت
    :beginner: -server ==> Information Of The Server | معلومات السيرفر
    :beginner: -count ===> Member Count | عدد الاشخاص في السيرفر
    :beginner: -cal =====> To Calculate | اله لحاسبة 
    :beginner: -tag =====> To Tag A Word | لعمل تاق لكلمة 
    :beginner: -rooms ===> Show Rooms Of Server | اضهار الرومات الي في السيرفر
    :beginner: -za5 =====> To decorate Some Word | لزخرفة الكلمات
    :beginner: -roles ===> Show Roles Of The Server | اضهار الرانكات
    :beginner: -emojis ==> Emoji Of Server | ايموجيات السيرفر   
    :beginner: -say =====> The Bot Say Any Thing | تكرار اي شي كتبتو
    :beginner: -image ===> To Show Image Of Server | لاضهار صورة السيرف 
    :beginner: -contact => To Contact Owners Bot | مراسلة صاحب البوت
    :beginner: -invite \ -inv => Invite Bot | لدعوة البوت
    :beginner: -embed ===> To Embed | لتكرار اي شي كتبتو بطريقة حلوة
    :beginner: -avatar ==> Your Avatar | صورتك الشخصية
    :beginner: -support => Server Support | سيرفر الدعم الفني
     ===========================================================
      React With ▶ To See Admins Commands`,
	`=-=-=-=-=-= 🔧  Admin Commands - اوامر ادارية 🔧 =-=-=-=-=-=
    :beginner: -move @user => Move User To Your Room Voice | لسحب الشخص الى روومك
    :beginner: -mvall => Move All To Your Room Voice | لسحب الجميع الي روومك
    :beginner: -bc => Broadcast | رسالة جماعية الى كل اعضاء السيرفر
    :beginner: -role @user <rank> => Give User Rank | لأعطاء رتبة لعضو معين
    :beginner: -roleremove @user <rank> => remove Rank From User | لازالة الرتبة من شخص معين
    :beginner: -role all <rank> => Give All Rank | لأعطاء رتبة للجميع
    :beginner: -role humans <rank> => Give Humans Rank | لأعطاء رتبة للاشخاص فقط
    :beginner: -role bots <rank> => Give Bots Rank | لأعطاء رتبة لجميع البوتات
    :beginner: -hchannel => Hide Channel | اخفاء الشات
    :beginner: -schannel => Show The Hidden Channel | اضهار الشات المخفية
    :beginner: -clr <numbr> => Clear Chat With Number | مسح الشات بعدد
    :beginner: -clear => Clear Chat | مسح الشات
    :beginner: -mute @user <reason> => Mute User | اعطاء العضو ميوت لازم رتبة <Muted>
    :beginner: -unmute @user => Unmute User | لفك الميوت عن الشخص 
    :beginner:-kick @user <reason> => Kick User From Server | طرد الشخص من السيرفر
    :beginner: -ban @user <reason> => Ban User From Server | حضر الشخص من السيرفر
    :beginner: -mutechannel => Mute Channel | تقفيل الشات
    :beginner: -unmutechannel => Unmute Channel | فتح الشات
    :beginner: -dc => Delete All Rooms |  مسح كل الرومات
    :beginner: -dr => Delete All Rank <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات
    :beginner: -ccolors <number> => Create Colors | ينشا لك الوان مع كم الوان تبي
    :beginner: -kv @user => Voice Kick | يطرد شخص من الرووم
    :beginner: -vonline => Create Channel Voice Online | يسوي رووم فويس اونلاين
     ===========================================================
    ...
    :beginner:� -xo @user => Game XO | لعب اكس او
    :beginner:� -rps => Rock & Paper & Scissors | لعبة حجر ورقة مقص
    :beginner:� -slots => Game Of Fruits | لعبة الفواكه
    :beginner:� -marry @user => لعبة الزواج
    :beginner:� -speed => لعبة سرعة كتابة 
    :beginner:� -لعبة فكك <= فكك
    :beginner:� -لعبة عواصم <= عواصم
    :beginner:� -البوت يعطيك نصائح <= هل تعلم
    ...
    :beginner: -play => لتشغيل أغنية برآبط أو بأسم
    :beginner: -skip => لتجآوز الأغنية الحآلية
    :beginner: -pause => إيقآف الأغنية مؤقتا
    :beginner: -resume => لموآصلة الإغنية بعد إيقآفهآ مؤقتا
    :beginner: -vol => لتغيير درجة الصوت 100 - 0
    :beginner: -stop => لإخرآج البوت من الروم
    :beginner: -np => لمعرفة الأغنية المشغلة حآليا
    :beginner: -queue => لمعرفة قآئمة التشغيل
